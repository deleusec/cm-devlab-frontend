...
function SearchBar() {
    ...
    return (
        <div className={`flex h-10 rounded-full bg-light-gray w-full max-w-[600px] ${isFocused && 'outline outline-2 outline-secondary'}`}>
            <input autoComplete="off" id="search" className="bg-transparent border-0 focus-visible:outline-0 flex h-full w-full px-6" type="text" placeholder="Search" onFocus={handleFocus} onBlur={handleFocus} />
